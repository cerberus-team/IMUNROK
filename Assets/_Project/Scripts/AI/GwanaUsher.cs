...
namespace IMUNROK.Common
{
    ...
    public class GwanaUsher : MonoBehaviour
    {
        ...
        {
            var l = _lines[_i];
            SubtitleView.Show(l.말한이, l.말, string.IsNullOrEmpty(l.아랫줄) ? "(Space 넘기기)" : l.아랫줄);
            l.그때?.Invoke();
        }
        ...
        private static Line[] Default()
        {
            return new[]
            {
                new Line { 말한이 = "서리", 말 = "게 뉘시오. 관아에 함부로 드는 법이 어디…", 아랫줄 = "(Space 넘기기)" },
                new Line { 말한이 = "서리", 말 = "…아이고. *마패*올시다. 어사또 나리, 몰라뵈었습니다.", 아랫줄 = "(Space 넘기기)" },
                new Line { 말한이 = "서리", 말 = "이 아래가 *문서고*입니다. 이 고을 문서는 죄 저 안에 들어 있습지요.\n호적이며 대장이며, 찾으실 것이 있거든 저리로 드십시오.", 아랫줄 = "(Space 넘기기)", 초 = 5.5f },
                new Line { 말한이 = "서리", 말 = "저 위가 *동헌*이올시다. 부르실 사람이 있거든 마루에 오르시면\n뜰에 대령시키겠습니다.", 아랫줄 = "(Space 넘기기)", 초 = 5f },
