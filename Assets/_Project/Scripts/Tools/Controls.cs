namespace IMUNROK.Common
{
    ...
    ///
    /// <b>2026-09-05 — 갈래를 하나로 줄였다.</b> 여기 있던 이름들은 하나같이
    /// 「이쪽이면 이 말, 저쪽이면 저 말」로 갈려 있었다. 이제 갈릴 일이 없으므로
    ...
    public static class Controls
    {
        ...
        /// 도구를 눈앞으로 들어 올리는 손짓.
        ///
        /// <b>2026-09-05 늦게 잡은 것.</b> 갈래를 줄이면서 이 클래스의 다른 이름은
