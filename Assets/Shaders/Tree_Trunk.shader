Shader "Unreal/Tree_Trunk"
{
    Properties
    {
		...
		Material_Texture2D_1( "Base Color Map", 2D ) = "white" {}
		Material_Texture2D_2( "Metallic Map", 2D ) = "white" {}
		Material_Texture2D_3( "Roughness Map", 2D ) = "white" {}
		Material_Texture2D_4( "Opacity Mask Map", 2D ) = "white" {}
		Material_Texture2D_5( "Translucency", 2D ) = "white" {}
		Material_Texture2D_6( "AO Map", 2D ) = "white" {}
